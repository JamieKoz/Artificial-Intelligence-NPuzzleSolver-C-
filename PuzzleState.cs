...
namespace NPuzzle
{
    public class PuzzleState : IEquatable<PuzzleState>
    {
        ...
        public List<Direction> GetPossibleActionsAdjusted()
        {
            ...
            if (blankTileMPos != 0) // Not at the top.
            {
                possibleMoves.Add(Direction.Up);
            }
            if (blankTileNPos != 0) // Not on the far left boundry.
            {
                possibleMoves.Add(Direction.Left);
            }
            if (blankTileMPos != (Puzzle.GetLength(1) - 1)) // Not at the bottom.
            {
                possibleMoves.Add(Direction.Down);
            }
            if (blankTileNPos != (Puzzle.GetLength(0) - 1)) // Not at the far right boundry.
            {
        ...
        {
            //populate children
            Direction[] possibleMoves = GetPossibleActionsAdjusted().ToArray();
        ...
        public List<PuzzleState> ExploreDFS()
        {
            //populate children
